...
@OnlyIn(Dist.CLIENT)
public class BillikenModel extends EntityModel<BillikenRenderState> {
    ...
    public void setupAnim(BillikenRenderState state) {
        super.setupAnim(state);
        this.animateWalk(BillikenAnimations.ANIM_BILLIKEN_WALK, state.walkAnimationPos, state.walkAnimationSpeed,9.0f, 100f);
        this.animate(state.idleAnimationState, BillikenAnimations.ANIM_BILLIKEN_IDLE, state.ageInTicks);
    }
